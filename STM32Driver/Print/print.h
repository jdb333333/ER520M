...
#define Drive_On(PH)  	{*(WORD *)PRT_PH_ADDR = PH; GPIOB->BSRRH = PHOEBIT; }
#define Drive_Off()    {*(WORD *)PRT_PH_ADDR = 0; GPIOB->BSRRL = PHOEBIT;}
...
#define PrnHotON() {GPIOB->BSRRH = HOTBIT;}     //打开加热
#define PrnHotOFF() {GPIOB->BSRRL = HOTBIT;}    //关闭加热
...
#define PrnPowerON() {GPIOC->BSRRL = POWERBIT;} //打开电源
#define PrnPowerOFF() {GPIOC->BSRRH = POWERBIT;}    //关闭电源
//#define PrnPowerOFF() {GPIOC->BSRRL = POWERBIT;}    //关闭电源
