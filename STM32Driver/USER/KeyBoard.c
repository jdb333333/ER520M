...
#include "netconfig.h"  //ccr2015-01-22
#endif
...
uint8_t key_value[]=					   /*  ?????????????????: ????????? */
{
	 0x00,0x00,0x00,0x05,0x04,0x03,0x02,0x01,
	 0x00,0x00,0x00,0x0A,0x09,0x08,0x07,0x07,
	 0x00,0x00,0x00,0x10,0x0F,0x0E,0x0D,0x0C,
	 0x00,0x1C,0x16,0x1B,0x15,0x14,0x13,0x12,
	 0x00,0x0B,0x06,0x1D,0x17,0x1A,0x19,0x18,
	 0x00,0x11,0x00,0x22,0x22,0x20,0x1F,0x1E,
	 0x00,0x26,0x21,0x26,0x21,0x25,0x24,0x23,
	 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
};
#elif CASE_ERA
uint8_t key_value[]=
...
void EXTILine_Init(void)
{
	...
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOE, EXTI_PinSource2);   //PFO
	...
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOE, EXTI_PinSource6);	//KB_INT
