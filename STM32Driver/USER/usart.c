...

{
	...
	if ( PortNum == LOGIC_COM1 )
	{
		...
		/* USART1 GPIO config */
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource6, GPIO_AF_USART1);  // USART1 Tx (PB.06)
		...
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource7, GPIO_AF_USART1);	// USART1 Rx (PB.07)
...
//        UARTSend(LOGIC_COM1,XON);//ccr2014-08-27
	...
	else if ( PortNum == LOGIC_COM2 )
	{
		...
		/* USARTx GPIO config */
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource10, GPIO_AF_USART3);  // USART3 Tx (PB.10)
		...
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource11, GPIO_AF_USART3);	// USART3 Rx (PB.11)
...
//        UARTSend(LOGIC_COM2,XON);//ccr2014-08-27
	...
	else if ( PortNum == LOGIC_COM3 )
	{
		...
		/* USART2 GPIO config */
		GPIO_PinAFConfig(GPIOA, GPIO_PinSource2, GPIO_AF_USART2);  // USART2 Tx (PA.02)
		...
		GPIO_PinAFConfig(GPIOA, GPIO_PinSource3, GPIO_AF_USART2);	// USART2 Rx (PA.03)
