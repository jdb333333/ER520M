...
#define ST7565R_CS_LOW()       GPIOF->BSRRH =	GPIO_Pin_7	// 清位
#define ST7565R_CS_HIGH()      GPIOF->BSRRL =	GPIO_Pin_7	// 置位

#define ST7565R_A0_CMD()       GPIOF->BSRRH =	GPIO_Pin_6	// 清位
#define ST7565R_A0_DATA()      GPIOF->BSRRL =	GPIO_Pin_6	// 置位

#define ST7565R_CLK_LOW()      GPIOG->BSRRH =	GPIO_Pin_15	// 清位
#define ST7565R_CLK_HIGH()     GPIOG->BSRRL =	GPIO_Pin_15	// 置位

#define ST7565R_SID_LOW()      GPIOF->BSRRH =	GPIO_Pin_8	// 清位
#define ST7565R_SID_HIGH()     GPIOF->BSRRL =	GPIO_Pin_8	// 置位
