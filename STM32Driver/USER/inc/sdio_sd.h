...
#define  BLOCK512                  1//ccr2014-08-06     //使用固定的512字节块大小还是使用从卡上识别的块大小

#define  SDBLOCKSIZE             (1024-512*BLOCK512) //ccr2014-08-06
...
extern volatile SD_Error SD_Status;
