...
#define TAXZERONAME "ZERO_VAT" //零税
#define TAXVATNAME "EXEMPT_VAT" //免税
...
#define RECOVRECPARAM "RECOV ECR PARAM"//jdb2018-08-02 恢复票据参数
...
#define PortType4               "KP-PORT"        //"厨  打",
#define PortType5               "SP-PORT"        //'票打'，20040322
...
#define SysFlags5               "OPER.COMP"        //"强制收款员"
#define SysFlags6               "OPER.SHFT"        //"改变收款员"
#define CLERKPASS               "OPER.PWD"        //"收款员密码"
#define SysFlags8               "PRT SALP."        //"打印营业员"
#define SysFlags9               "PRT OPER."        //"打印收款员"
#define SysFlags10              "PRT R-NO"        //"打印收据号"
#define SysFlags11              "HEAVY PRN"        //"高浓度打印"
#define SysFlags12              "SALP.COMP"        //"强制营业员"
#define SysFlags13              "PRT PLU#"        //"打印编码:"
#define SysFlags14              "SUB.MUST"        //"按小计键:"
#define SysFlags15              "PRN.ITEMS"        //"打印项目数"
#define SysFlags16              "STUB"        //"打印小票:"
#define SysFlags17              "STUB HEAD"        //"小票票头:"
#define SysFlags18              "SHIFT LOCK"        //"锁定SHIFT:"
#define SysFlags19              "IDLE TIME"        //"显示时间:"
#define SysFlags20              "RECE. COPY"        //"复制收据:"
#define SysFlags21              "SCALE CODE"        //"特殊条码:"
#define SysFlags22              "OPR. LOG" //-----090421 BY ZY//"操作日志"
#define SysFlags23              "PRINT PB"        //"开台打印:"
#define SysFlags24              "PRN STOCK"        //"打印库存"
#define SysFlags25              "PRN ON/OFF"        //"打印开关:"
#define SysFlags26              "CHECK REQUIRED"        //"必须开台:"
#define SysFlags27              "KEEP R-NO#"        //"保持收据号"
#define SysFlags28              "KP COPY"        //"复制厨打:"
#define SysFlags29              "RESET R-NO"        //"收据号复位"
#define SysFlags30              "DOUBLE PRT"    //-----090421 BY ZY//"倍高打印"
#define SysFlags31              "CONTRAST"   //-----090421 BY ZY//"对比度:"
#define SysFlags32              "->HEAD<-"  // "票头居中打印"
#define SysFlags33              "->TRAIL<-"  // "票尾居中打印"
#define SysFlags34              "DBLH HEAD"  // "票头倍高打印"
#define SysFlags35              "DBLH TRAL"  // "票尾倍高打印"
...
#define SetupMode1              "GENERAL SET"  //---090421 BY ZY// "综合功能",
...
#define SetupCaption4           "PRINT PLUS"			//"打印商品清单",
#define msgSETTEST              "TEST ECR"//"系统测试"            //SETTEST
#define msgSETCLEARPLU          "CLEAR PLU"//"清除单品"        //SETCLEARPLU
#define msgSETPLULIST           "PRN DEPT/PLU"//"打印商品清单"      //SETPLULIST
...
#define SetupCaption11          "KITCHEN PRINT"			// "厨房打印",
...
#define SetupCaption40          "PG-PASSWORD"          //ZY  // "设置档密码",
#define SetupCaption41          "MG-PASSWORD"          //ZY  // "经理档密码",
#define SetupCaption42          "X-PASSWORD"     //ZY  // "只读报表密码",
#define SetupCaption43          "Z-PASSWORD"     //ZY  // "清帐报表密码",
#define SetupCaption44          "MEMORY"        //ZY  // "打印测试",
#define SetupCaption45          "DISPLAY"       //ZY  //"显示测试",
#define SetupCaption451         "CUSTOMER"      // 客显测试
#define SetupCaption46          "PRINTER"      //ZY  //"打印版本",
#define SetupTestRAM           "CHECK RAM"        //SETTSTMEM	       //RAM测试
#define SetupCaption47          "CLOCK"      //ZY  //"时钟测试",
#define SetupCaption48          "BUZZER"     //ZY  //"蜂鸣器测试",
#define SetupCaption49          "DRAWER"     //ZY  //"钱箱测试",
#define SetupCaption50          "KEYBOARD"       //ZY  //"键盘测试",
#define SetupCaption51          "SERIAL PORTS"        //ZY  //"串口测试",
#define SetupCaption52          "SELF-TEST"       //ZY  //"自动测试",
...
#define CaptionN3               "PRICE"  // "价格",
#define CaptionN8               "CHANGE"  // "找零",

#define CaptionN39              "ADD PLU?"  // "增加?",
#define CaptionN40              "DEL PLU?"  // "删除?",
...
#define CaptionN64              "ALTER PRICE"  // "改变单品价格",
#define CaptionN65              "KP GROUP"  // "厨房打印机组"，
...
#define CaptionE1               "RS232 ERR"  // "RS232错",
#define CaptionE2               "RS232 OK"  // "RS232正确",
#define CaptionE3               "RTC ERR!"  // "RTC 错!",
#define CaptionE4               "CTC ERR!"  // "CTC 错!",
#define CaptionE5               "FPROM ERR!"  // "FPROM错!",
#define CaptionE6               "INITIALIZING."  // "初始化...",
#define CaptionE7               "INIT.COMPLETE"  // "初始化结束.",
#define CaptionE8               "ERROR"  // "出错-",//长度<SCREENWD

#define CaptionE9               "PWD ERR!"  // "密码错 ！",
#define CaptionE10              "PWD SAVED"  // "密码已保存",
...
#define CaptionE28              "LOG-MEMORY FULL"  // "流水存储区满",
#define CaptionE29              "PAPER END"  // "请更换打印纸",
#define CaptionE30              "EXTD MEM ERR"  // "扩展内存出错！",



#define CaptionE32              "INVALIDINPUT"  // "无效输入!",
...
#define CaptionE45              "IN TRADING!"  // "仍在销售中!",
#define CaptionE46              "BUFFER FULL"  // "销售缓冲区满",
#define CaptionE47              "ITEM NOT SOLD"  // "商品没有售出",
#define CaptionE48              "IN TRADING!"  // "正在结算中!",
#define CaptionE49              "INVALID NUM."  // "输入数据超长",
...
#define CaptionE58              "PRT INTERRUPT"  // "报表打印中断",
#define CaptionE59              "MG-MODE MUST"  // "必须在经理档",
#define CaptionE60              "CAN'T SPLIT"  // "不能分帐时用",
#define CaptionE61              "INPUT NOADD#!"  // "必须输入号码",
#define CaptionE62              "KEY-POS ERROR"  // "钥匙档位错",
#define CaptionE63              "UNAUTHORIZED"  // "未授权!",
#define CaptionE64              "OPER.REQUIRED"  // "请指定收款员",
#define CaptionE65              "SALP.REQUIRED"  // "请指定营业员",
#define CaptionE66              "NOT ALLOWED!"  // "禁止PLU变价！",
#define CaptionE67              "PASSWORD ERR!"  //  "密码不对!",
#define CaptionE68              "K-PRINT ERR"  // "厨房打印机错",
...
#define CaptionE72              "OVERHEATING!"  // "打印温度太高",
#define CaptionE73              "FUNC UNDEFINE"  // "功能未定义!",
...
#define CaptionERR106             "STOCK DISABL"	//20070806"没激活库存"
//ccr090715>>>>>>>>>>>>>>>>>>>>>>
...
#define DownLoad1               ">> FONT"  // "正在下载字库",
#define DownLoad2               ">> GRAP"  // "正在下载图形",


#define OptionN1                "YES"  // "是",
#define OptionN2                " NO"  // "否",
#define OptionN3                "NAME "  // "名称:",
#define OptionN4                "DEPART"  // "部类:",
...
#define OptionN15               "BUY"  // "进价:",
#define OptionN16               "DISC(%)"  // "折扣率(%):",
#define OptionN17               "MAX"  // "最大值:",
#define OptionN18               "DISC"  // "折扣率:",
...
#define OptionN42               "PWD."  // "密码:",
#define OptionN43               "FREQUENT"  // "频率:",
#define OptionN44               "THRESHOLD"  // "最小金额:",
#define OptionN45               "PORT"  // "通讯口:",
#define OptionN46               "VALUE"  // "计点金额:",
...
#define MessagesN4                "KITCHEN #"  // "厨房打印机#",																						//CHFDYJHAO
#define MessagesN13               "<>"
...
#define ClueN1                    "PRESS ENTER..."  // "按确认键...",
  ...
  //Option for KP
#define OptionS1                  "PRT.TOTAL"  // "打印总额:",
...
#define OptionS8                  "DISC. 2"  // "折扣项 2:",
  //Options for tend
#define OptionS9                  "OPENDRAWER"  // "打开钱箱:",
#define OptionS10                 "AMT. COMP."  // "输入金额:",
#define OptionS11                 "FORBIDDEN"  // "禁止输入:",
#define OptionS12                 "NOADD#:"  // "输入号码:",
...
#define OptionS17                 "PO/RA"  // "入金/出金",
  //Option for Disc
#define OptionS18                 "PRINT DISC."  // "打印折扣额",
...
#define EditN28                   "PRINT DATE"  // '打印信息',
#define EditN29                   "SEC RECEIPT"  // '第二张票据',
#define EditN30                   "LEFT MARGIN"  // '左边距',
#define EditN31                   "TYPE"  // '票打机型',
#define EditN32                   "PRINTER OFF"  // "打印机关",
#define EditN33                   "PRINTER ON"  // "打印机开",
  //ChipCard>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#define ChipCardN1                "PWD"  //I "密码:",
#define ChipCardN2                "PWD CONF."  // "密码确认:",
#define ChipCardN3                "POS CODE"  // "POS代码:",
#define ChipCardN4                "POS CONF."  // "代码确认:",
#define ChipCardN5                "POS SAVED"  // "代码已保存",
#define ChipCardN6                "POS ERR."  // "代码错 ！",
...
#define ChipCardN12               "AUTO DISC"  // "自动折扣:",
#define ChipCardN13               "POINTS"  // "消费积分:",
#define ChipCardN14               "CASH=CC"  // "用现金键:",
#define ChipCardN15               "DEAD DATE"  // "启用有效期", //
...
#define ChipCardN24               "PRICE LVL"  // "价格级别:",
#define ChipCardN25               "PIN"  // "PIN码:",
#define ChipCardN26               "PROTECT LVL"  // "保护级别:",
#define ChipCardN27               "AUTO CHECK"  // "自动结帐:",
#define ChipCardN28               "INIT DATE"  // "制卡日期:",
#define ChipCardN29               "DEAD DATE"  // "卡有效期:",
...
#define InputMode2				"QU:" // "区："
#define InputMode3				"PING:" // "拼："
...
#define GPRSstr11 "FINISHED"  // "数据已发出.. "
