...
#define ReportType5     "  PAGO/CAJA "        //" 出 入 金 信 息 ",//5                                             
...
#define DRAWER3            "TAR DE CRED"        //"信用卡  "L打印/显示                                                               
#define DRAWER4            "CUPON  "        //"购物券  "L打印/显示                                                                
#define DRAWER5            "CREDITO  "        //"赊账    "L打印/显示                                                                
#define DRAWER6            "TAR DE CHIP"        //"IC卡    "L打印/显示                                                               
#if  defined(CASE_INDONESIA)
...
#define PBFunction5         "IM DE CUENTA"        //   "打印帐单"                                      
...
#define TendType3             "TAR DE CREDI"        //"信用卡  "                                                                     
