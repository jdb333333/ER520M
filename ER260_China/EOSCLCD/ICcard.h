...
//jdb2018-03-08
#define MsgSCNAME     	"SC#"
#define MsgPWDNAME     	"PWD#"
#define MsgNOSC    		"NO SC ID#"
#define MsgNOPWD    	"NO PWD ID#"
...
//jdb2018-03-08
#define VIP_SCPWD	BIT4	//SC OR PWD LOGIN
#define	VIP_ERR		BIT5	//LOGIN ERR
...
struct TECRVIP
{
    ...
    WORD ECRVIPState;   // ECRVIPState操作标志:
                        ...
                        //		VIP_SCPWD,BIT4:表示SC PWD 登录	//jdb2018-03-08
                        //		VIP_ERR,BIT5:表示登录出错	//jdb2018-03-08
    UnLong VipPoints;  //会员积分
