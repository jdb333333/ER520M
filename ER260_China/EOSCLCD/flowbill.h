...
#define  VATLOG			28		//jdb2018-07-19 VAT Log
#define  ZEROLOG		29		//jdb2018-07-19 ZERO Log
...
#define  LOGTYPEMAX  	29      //jdb2018-07-19 增加了免税、零税流水
#endif//ccr2016-06-03<<<<<<<<<<<<<<<<<<<
...
union FLOWREC
{
    ...
    struct CDC_VAT			 CDC_Vat;				//jdb2018-07-19 VAT record
    struct CDC_ZERO			 CDC_Zero;				//jdb2018-07-19 ZERO record
#if defined(CASE_INDIA)//ccr2016-06-03>>>>
