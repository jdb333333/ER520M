...
#else //jdb2018-06-20 修改为4个报表
#define XZTITLE1		XZTITLE		//销售日报表
#define XZTITLE3		(XZTITLE1+1)      //商品报表
#define XZTITLE5		(XZTITLE3+1)      //时段报表
#define XZTITLE8		(XZTITLE5+1)      //全收款员日报表
#endif
#if (salNumber)
...
#define eCARREMAIN		(XZTITLE1+XZITEMSMAX-1)     //jdb2018-06-20
...
extern const char
    ...
    cMsg_RECNUMFR[], //"Rec_FROM"                  //RECNUMFR    cMsg_RECNUMTO[], //"Rec_TO"                    //RECNUMTO    cMsg_EJBBIAO[],  //	"~E~J ~R~E~P~O~R~T"		//EJBBIAO    cMsg_EJXINXI[],  //	"EJ INFORMATIONS"            //EJXINXI    cMsg_EJBHAO[],   //"CODE"						//EJBHAO
    cMsg_SIZEEJ[],   //"Size of EJ"				//SIZEEJ
    cMsg_EJCSHUA[],  //	"EJ INITIALIZED"	   //EJCSHUA    cMsg_EJLEFT[],   //Msg_EJLEFT,
    cMsg_FORMAT[],
    ...
    cVIPTOTAL[],//VIPTOTAL 总额
		cVIPLESSVAT[],//jdb2018-03-08
		cVIPDISC[],//jdb2018-03-08
